...
public class storyTwo {
    ...
    public void wallTwo(Player character, Inventory objIn){
       ...
       audioManager.playAudio("textBasedgame-master/OST/Dark Souls_ Chiptune Demixes - Knight Artorias.wav");
       System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
        ...
        while (objFoss.getHealth() > 0 && character.getHealth() > 0){
            ...
            try {
                ...
                if (character.getHealth() <= 0) {
                    ...
                    audioManager.playAudio("textBasedgame-master/OST/Dark Souls_ Chiptune Demixes - Crossbreed Priscilla.wav");
                    System.out.println("-----------------------------------------------\n");
        ...
        while (objJorm.getHealth() > 0 && character.getHealth() > 0) {
            ...
            try {
                ...
                if (character.getHealth() <= 0) {
                    ...
                    audioManager.stopAudio();
                    audioManager.playAudio("textBasedgame-master/OST/Undertale OST_ 033 - Quiet Water.wav");
                    System.out.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
                    System.out.println("-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-");
